...
public class GameSystem {
	...
	public BaseUnit promote(BaseUnit baseUnit ,int choice) {
		MeleeUnit obj0 = new MeleeUnit(baseUnit.getColumn() ,baseUnit.getRow(),
		        baseUnit.isWhite() , baseUnit.getName());
		RangeUnit obj1 = new RangeUnit(baseUnit.getColumn() ,baseUnit.getRow(),
		        baseUnit.isWhite() , baseUnit.getName());
		FlyingUnit obj2 = new FlyingUnit(baseUnit.getColumn() ,baseUnit.getRow(),
		        baseUnit.isWhite() , baseUnit.getName());
		 if(choice == 0) {
			 return obj0;
		 }else if(choice == 1) {
